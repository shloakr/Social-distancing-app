...
while True:
    ...
    if len(idxs) > 0:
        ...
        for i in idf:
            ...
            # cv2.putText(FR, "Social Distancing Analyser COVID-19", (210, H+60),
            ...
            print("TOTAL COUNT: " + str(total_p) + " LOW RISK: " + str(low_risk_p) + " HIGH RISK: " + str(high_risk_p) + " SAFE: " + str(safe_p))
            ...
            if high_risk_p > 1 and done == False:
                done = True
                # Download the helper library from https://www.twilio.com/docs/python/install
               
                # Find your Account SID and Auth Token at twilio.com/console
                # and set the environment variables. See http://twil.io/secure
                account_sid = 'AC419d373b8079b4a7208859e410450fb1'
                auth_token = '7aa424a9eed631d535845ae5e2ab1f3e'
                client = Client(account_sid, auth_token)

                message = client.messages.create(
                                              body='Overcrowding risk detected.',
                                              from_='+12626864433',
                                              to='+917506402049'
                                          )
